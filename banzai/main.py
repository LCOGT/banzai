...
from banzai.images import Image, read_images
...
def make_master_bias(pipeline_context=None, raw_path=None):
    pipeline_context, raw_path = parse_directory_args(pipeline_context, raw_path, settings.IMAGING_CRITERIA, Image)
...
def reduce_single_science_frame():
    ...
    pipeline_context, raw_path = parse_directory_args(None, None, settings.IMAGING_CRITERIA, Image,
...
def reduce_night():
    ...
    pipeline_context = parse_args(settings.IMAGING_CRITERIA, Image, extra_console_arguments=extra_console_arguments,
...
def run_preview_pipeline():
    ...
    pipeline_context = parse_args(settings.IMAGING_CRITERIA, Image,
