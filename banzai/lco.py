...
class LCOObservationFrame(ObservationFrame):
    ...
    @property
    def site(self):
        return self.primary_hdu.meta.get('SITENAME')
    ...
    @property
    def read_noise(self):
        return self.primary_hdu.meta.get('ENOISE')

    @read_noise.setter
    def read_noise(self, value):
        self.primary_hdu.meta['ENOISE'] = value

    @property
    def pixel_scale(self):
        return self.primary_hdu.meta.get('SCALE')
    ...
    def ccd_temperature(self):
        return int(self.primary_hdu.meta.get('TEMPCCD', 0.0))

    @property
    def requested_ccd_temperature(self):
        return self.primary_hdu.meta.get('TEMPCCD', 0.0)
...
class LCOFrameFactory(FrameFactory):
    ...
    def open(self, file_info, runtime_context) -> Optional[ObservationFrame]:
        ...
        if fits_hdu_list[0].header['EXPTYPE'] in associated_fits_extensions or \
