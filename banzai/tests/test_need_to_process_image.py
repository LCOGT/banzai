...
@mock.patch('banzai.realtime.image_can_be_processed')
@mock.patch('banzai.realtime.get_primary_header')
def test_no_processing_if_previous_success(mock_header, mock_can_process, mock_processed, mock_md5):
...
@mock.patch('banzai.realtime.image_can_be_processed')
@mock.patch('banzai.realtime.get_primary_header')
def test_do_process_if_never_tried(mock_header, mock_can_process, mock_processed, mock_md5, mock_commit):
    mock_can_process.return_value = True
...
@mock.patch('banzai.realtime.image_can_be_processed')
@mock.patch('banzai.realtime.get_primary_header')
def test_do_process_if_tries_less_than_max(mock_header, mock_can_process, mock_processed, mock_md5, mock_commit):
    mock_can_process.return_value = True
...
@mock.patch('banzai.realtime.image_can_be_processed')
@mock.patch('banzai.realtime.get_primary_header')
def test_no_processing_if_tries_at_max(mock_header, mock_can_process, mock_processed, mock_md5, mock_commit):
    max_tries = 5
    mock_can_process.return_value = True
...
@mock.patch('banzai.realtime.image_can_be_processed')
@mock.patch('banzai.realtime.get_primary_header')
def test_do_process_if_new_checksum(mock_header, mock_can_process, mock_processed, mock_md5, mock_commit):
