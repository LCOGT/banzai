...
from banzai.tests.dark_utils import make_context_with_realistic_master_dark
...
@mock.patch('banzai.calibrations.ApplyCalibration.get_calibration_filename')
def test_dark_subtraction_is_reasonable(mock_cal):
    ...
    context = make_context_with_realistic_master_dark(dark_level=input_dark, readnoise=input_readnoise, nx=nx, ny=ny,
