...
# Stop after 4 attempts, and back off exponentially with a minimum wait time of 10 seconds, and a maximum of 60.
# If it fails after 10 attempts, "reraise" the original exception back up to the caller.
@retry(wait=wait_exponential(multiplier=10, min=10, max=60), stop=stop_after_attempt(10), reraise=True)
