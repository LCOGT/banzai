...
def read_image(filename, runtime_context, nx_rows_to_read_in=None):
    try:
        image = FRAME_CLASS(runtime_context, filename=filename, nx_rows_to_read_in=nx_rows_to_read_in)
