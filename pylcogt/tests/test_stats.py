...
def _compare_median1d(a, mask):
    actual = stats._median1d(a.astype('f4'), mask=mask.astype(np.uint8))
...
def test_median1d_all_masks_returns_zero():
    ...
    assert stats._median1d(a, mask) == 0.0
...
def _compare_median2d(a, mask):
    actual = stats._median2d(a.astype('f4'), mask.astype(np.uint8))
...
#
#
# def test_median_axis_none_mask_nose():
#     assert 1 == 0
#
#
# def test_median_axis_mask_none():
#     assert 1 == 0
#
#
